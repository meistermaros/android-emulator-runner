...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // launch an emulator
            yield (0, emulator_manager_1.launchEmulator)(apiLevel, target, arch, profile, cores, ramSize, heapSize, sdcardPathOrSize, diskSize, avdName, forceAvdCreation, emulatorBootTimeout, emulatorOptions, disableAnimations, disableSpellchecker, disableLinuxHardwareAcceleration, enableHardwareKeyboard, emulatorPort);
            ...
            yield (0, emulator_manager_1.killEmulator)(emulatorPort);
        }
        catch (error) {
